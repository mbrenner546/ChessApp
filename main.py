...
bp = Piece('b', 'p', 'chess_pieces/bp.png')
wp = Piece('w', 'p', 'chess_pieces/wp.png')
bk = Piece('b', 'k', 'chess_pieces/bk.png')
wk = Piece('w', 'k', 'chess_pieces/wk.png')
br = Piece('b', 'r', 'chess_pieces/bc.png')
wr = Piece('w', 'r', 'chess_pieces/wc.png')
bb = Piece('b', 'b', 'chess_pieces/bb.png')
wb = Piece('w', 'b', 'chess_pieces/wb.png')
bq = Piece('b', 'q', 'chess_pieces/bq.png')
wq = Piece('w', 'q', 'chess_pieces/wq.png')
bkn = Piece('b', 'kn', 'chess_pieces/bh.png')
wkn = Piece('w', 'kn', 'chess_pieces/wh.png')


starting_order = {(0, 0): pygame.image.load(br.image), (1, 0): pygame.image.load(bkn.image), (2, 0): pygame.image.load(bb.image), (3, 0): pygame.image.load(bk.image),  (4, 0): pygame.image.load(bq.image), (5, 0): pygame.image.load(bb.image),(6, 0): pygame.image.load(bkn.image), (7, 0): pygame.image.load(br.image),  (0, 1): pygame.image.load(bp.image), (1, 1): pygame.image.load(bp.image),(2, 1): pygame.image.load(bp.image), (3, 1): pygame.image.load(bp.image),
...
def create_board(board):
    board[0] = [Piece('b', 'r', 'chess_pieces/bc.png'), Piece('b', 'kn', 'chess_pieces/bh.png'), Piece('b', 'b', 'chess_pieces/bb.png'), \
               Piece('b', 'q', 'chess_pieces/bq.png'), Piece('b', 'k', 'chess_pieces/bk.png'), Piece('b', 'b', 'chess_pieces/bb.png'), \
               Piece('b', 'kn', 'chess_pieces/bh.png'), Piece('b', 'r', 'chess_pieces/bc.png')]

    board[0] = [Piece('w', 'r', 'chess_piecesw/c.png'), Piece('w', 'kn', 'chess_pieces/wh.png'), Piece('w', 'b', 'chess_pieces/wb.png'), \
               Piece('w', 'q', 'chess_pieces/wq.png'), Piece('w', 'k', 'chess_pieces/wk.png'), Piece('w', 'b', 'chess_pieces/wb.png'), \
               Piece('w', 'kn', 'chess_pieces/wh.png'), Piece('w', 'r', 'chess_pieces/wc.png')]

    for i in range(8):
        board[1][i] = Piece('b', 'p', 'chess_pieces\bp.png')
        board[6][i] = Piece('w', 'p', 'chess_pieces\wp.png')
    return board
